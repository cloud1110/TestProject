$(document).ready(function(){
	...
	var current_theme = $.cookie('current_theme')==null ? 'ata' :$.cookie('current_theme');
	...
	{
		$('#bs-css').attr('href',static_url + 'css/bootstrap-ata.css');
	}
...
function docReady(){
    ...
    $('.datepicker,.start_time,.end_time').datetimepicker();
